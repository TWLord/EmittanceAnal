...
#                                 self.not_used_triplet, self.not_used_doublet]:
    ...
    def death(self):
        ...
        #print self.plots["p_tku_vs_tof01_us cut"] # TomL
        #print self.plots["p_tku_vs_tof01_us cut"].keys() # TomL
        #self.plots["p_tku_vs_tof01_us cut"]["canvas"].cd() # TomL
        #self.plots["p_tku_vs_tof01_us cut"]["canvas"].Draw() # TomL
        #self.plots["p_tku_vs_tof01_us cut"]["canvas"].Update() # TomL
        #self.plots["p_tku_vs_tof01_us cut"]["canvas"].Print(self.plot_dir+"/quicktesting.png") # TomL
        self.print_plots()
    ...
    def birth_p_tot_vs_tof(self, tof, tk, cuts):
        ...
        y_list = [float(p) for p in range(100, 260, 10)] # TomL
    ...
    def process_p_tot_vs_tof(self, tof, tk, cuts):
        ...
        #print hist # TomL
        #hist = hist.values()[0] # ChrisR
        hist = hist["p_tot_vs_tof"] # TomL
        #print "hist :" # TomL
        #print hist # TomL
        #print "tof_data length is " + str(len(tof_data)) # TomL
        #print tof_data[0] # TomL
        #print "p_data length is " + str(len(p_data)) # TomL
        #print p_data[0] # TomL
