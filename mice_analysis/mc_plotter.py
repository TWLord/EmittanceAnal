...
class MCPlotter(AnalysisBase):
    ...
    def birth(self):
        ...
        for detector, virt_station_list in self.mc_stations.iteritems():
            ...
            self.birth_var_two_d_hist("pt_vs_pz_at_"+virt_station+"_us_cut_hist", virt_station, "pt", "pz", "us cut")
    ...
    def birth_var_two_d_hist(self, canvas_name, detector, plot_variable_1, plot_variable_2, cuts=False):
