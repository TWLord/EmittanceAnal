    ...
    def __init__(self, beam, target_dir, top_labels, right_labels):
        ...
        if do_higher_mom :
          ...
          self.conglomerate_list = [
            ...
            self.get_conglomerate_2("tof_tof0_n_sp_"+nu+"_0", None, "Number of space points in ToF0", None, True, [0.5, 0.5, 0.9, 0.9], vertical([0.5, 1.5], mod)),
            self.get_conglomerate_2("tof_tof1_n_sp_"+nu+"_0", None, "Number of space points in ToF1", None, True, [0.5, 0.5, 0.9, 0.9], vertical([0.5, 1.5], mod)),
            self.get_conglomerate_2("tof_tof01_"+nu+"_0", None, "Time between ToF0 and ToF1 [ns]", [2.5, 6.], True, [0.5, 0.5, 0.9, 0.9], vertical([3.0, 3.5, 4.0, 4.5, 5.0, 5.5], mod)),
            #self.get_conglomerate_2("tof_delta_tof01_"+nu1+"_0", None, "t(ToF01) - extrapolated t(ToF01) [ns]", None, True, [0.1, 0.5, 0.5, 0.9], mod),
...
class PressPlotsAmplitudeConfigData(CompareConfig): # data plots
    def __init__(self, beam, target_dir, top_labels, right_labels):
        ...
        absolute_modifiers_err = {
            ...
            "normalise_graph":"Upstream stats",#True,
            "redraw":{
                    "graph":{
                        "draw_option":["p", "p", "3", "p", "p", "3"],
                        "marker_style":[24, 20, 20, 26, 22, 22],
...
def main_paper(batch_level = 0):
 ...
 #for tdir in range(3) :
    ...
    #target_dir = "output/combinedMC+Data/officialMC/2017-02-6_OfficialMC/"

    #target_dir = "/data/mice/phumhf/backupOutput/combinedMC+Data/officialMC/2017-02-6-c3-OfficialMC_v3+c10_redo2/"

    #target_dir = "output/combinedMC+Data/officialMC/2017-02-6-c1_v3+c10_highmom/"

    target_dir = "output/combinedMC+Data/officialMC/2017-02-6_amp/v4/"
    ...
    #target_dir = "output/combinedMC+Data/testingAng6/"
    #target_dir = "output/combinedMC+Data/testingAngPlotter/"
    #target_dir = "output/combinedMC+Data/testingAngPlotter2/"
    #target_dir = "output/combinedMC+Data/testingAngPlotter3/"
    ...
    #target_dir = "output/combinedMC+Data/flipped_hists/"
    ...
    my_dir_list = [
        ...
        #["2017-02-6_3-140_ABS-LH2",   "2017-02-6_4-140_ABS-SOLID-EMPTY",   "2017-02-6_6-140_ABS-LH2",   "2017-02-6_10-140_ABS-LH2",],
        ...
        #["2017-02-6_3-140_ABS-LH2-EMPTY",   ], # TomL
        #["2017-02-6_3-140_ABS-LH2",         ], # TomL
        #["2017-02-6_3-140_ABS-SOLID-EMPTY", ], # TomL
        #["2017-02-6_3-140_ABS-SOLID-LiH",   ],
        ...
        #["2017-02-6_4-140_ABS-SOLID-EMPTY", ],
        #["2017-02-6_4-140_ABS-SOLID-LiH", ],
