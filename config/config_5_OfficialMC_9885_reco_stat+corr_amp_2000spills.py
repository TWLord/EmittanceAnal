...
class Config(object):
    ...
    data_dir = "output/officialMC/2017-02-6-v5-reco-sys+corr-longmc-longdata-amp-2000/"
    ...
    number_of_spills = 2000 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
