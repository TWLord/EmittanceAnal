...
class Config(object):
    ...
    downstream_cuts["pt_us"] = False # stopped pt cut
    downstream_cuts["pt_ds"] = False # stopped pt cut
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_fullpt6/"
    analyses = []


    analyses.append(get_analysis(["9909"],  "9909 2017-02-6 3-240 ABS-LH2",  [1.5, 2.75], src_dir, data_dir, 3, [[230, 250]], [190, 270], 24)) 
    ...
    number_of_spills = 200 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
