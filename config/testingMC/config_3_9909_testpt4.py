...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp):
    ...
    analysis_variables = {
            ...
            "pt_us_high":20., # upstream transverse momentum cut lower bound
            "pt_ds_low":0., # upstream transverse momentum cut lower bound
            "pt_ds_high":20., # upstream transverse momentum cut lower bound
...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_fullpt4/"
    analyses = []
    ...
    preanalysis_number_of_spills = 1 # 20 # number of spills to analyse during "pre-analysis"
