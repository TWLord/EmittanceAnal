...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_full16/"
    analyses = []
    ...
    number_of_spills = 200 # 50 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
    preanalysis_number_of_spills = 2 # 5 # 20 # number of spills to analyse during "pre-analysis"
