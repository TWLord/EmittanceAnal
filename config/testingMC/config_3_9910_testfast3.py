...
class Config(object):
    ...
    reduced_dict_path = "reduced_files/MCv3/9910/"
    analyses = []


    analyses.append(get_analysis(["9910"],  "Simulated 2017-02-6 3-200 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 3, [[195, 205]], [150, 230], 24)) 
