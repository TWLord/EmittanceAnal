...
class Config(object):
    ...
    reduced_dict_path = "reduced_files/MCv3/9911/"
    analyses = []


    analyses.append(get_analysis(["9911"],  "Simulated 2017-02-6 3-170 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 3, [[165, 175]], [120, 200], 24)) 
