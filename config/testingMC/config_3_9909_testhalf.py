...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_half/"
    reduced_dict_path = "reduced_files/MCv3/fast_preanalysis/9909/"
    analyses = []
    ...
    number_of_spills = 500 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
