...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_full3/"
    analyses = []
    ...
    number_of_spills = 250 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
