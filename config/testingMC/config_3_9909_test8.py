...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_full8/"
    analyses = []


    analyses.append(get_analysis(["9909"],  "9909 2017-02-6 3-240 ABS-LH2",  [1.5, 2.75], src_dir, data_dir, 3, [[200, 280]], [190, 270], 24)) 
    ...
    number_of_spills = 150 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
