...
class Config(object):
    ...
    mc_true_ds_cuts["mc_scifi_fiducial_ds"] = False # True
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_full/"
    reduced_dict_path = "reduced_files/MCv3/9909/"
    analyses = []
    ...
    number_of_spills = 10 # 2 # 5 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
    preanalysis_number_of_spills = 1 # 1 # 5 # 20 # number of spills to analyse during "pre-analysis"
    analysis_number_of_spills = 1 # 1 # 20 # number of spills to analyse during each "analysis" step
