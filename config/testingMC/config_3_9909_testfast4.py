...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_fast4/"
    reduced_dict_path = "reduced_files/MCv3/9909/"
    analyses = []


    analyses.append(get_analysis(["9909"],  "Simulated 2017-02-6 3-240 ABS-LH2",  [1.5, 2.75], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24)) 
    ...
    mc_plots = {
        "mc_stations" : {
            ...
            "global_through_virtual_absorber_centre":["mc_virtual_absorber_centre"],
            "global_through_virtual_lh2_us_window_flange_1":["mc_virtual_lh2_us_window_flange_1"],
            "global_through_virtual_lh2_ds_window_flange_1":["mc_virtual_lh2_ds_window_flange_2"],
            "global_through_virtual_ssd_aperture":["mc_virtual_ssd_aperture"],
        }
    }
    bz_tku = 3e-3
    bz_tkd = 2e-3
