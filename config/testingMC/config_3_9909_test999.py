...
def mc_file_names(run_number_list):
    ...
    for run in run_number_list:
        ...
        a_file = "/data/mice/phumhf/analMC/09909_v26/*/maus_output.root" 
...
class Config(object):
    ...
    number_of_spills = 25 # 5 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
    preanalysis_number_of_spills = 1 # 5 # 20 # number of spills to analyse during "pre-analysis"
    analysis_number_of_spills = 5 # 20 # number of spills to analyse during each "analysis" step
