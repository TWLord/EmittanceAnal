...
class Config(object):
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_full5/"
    analyses = []
    ...
    number_of_spills = 20 # 8 # None # if set to an integer, limits the number of spills loaded for each sub-analysis
