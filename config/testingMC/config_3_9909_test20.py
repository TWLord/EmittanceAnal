...
class Config(object):
    ...
    downstream_cuts["chi2_ds"] = False #True
    downstream_cuts["scifi_fiducial_ds"] = False #True
    ...
    data_dir = "output/testingofficialMC/2017-02-6-v3-OfficialMC_full20/"
    analyses = []
