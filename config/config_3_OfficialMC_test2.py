...
def mc_file_names(datasets):
    file_list = ["/data/mice/phumhf/MC/MAUSv3.3.2/"+datasets+"/"+datasets+"_mc.root"]
...
class Config(object):
    ...
    #data_dir = "output/officialMC/2017-02-6-v3-OfficialMC+TOFcuts-mc+density+densityrogers/"
    data_dir = "output/testing2/2017-02-6-v3-OfficialMC+TOFcuts-mc+density+densityrogers/"
    files = "*/Chris/*/"
    analyses = []
