...
def reco_file_names(run_number_list, maus):
    ...
    for run in run_number_list:
        ...
        a_file = "/data/mice/phumhf/ReconData/Mausv3.3.2/run_"+run+"/"+run+"_recon.root" # "+maus+"/"+run+"/"+run+"_recon"
...
class Config(object):
    ...
    analyses.append(get_analysis([9886],  "2017-02-6 10-140 lH2 full",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70))
