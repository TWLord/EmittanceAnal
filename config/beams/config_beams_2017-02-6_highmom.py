...
class Config(object):
    ...
    #analyses.append(get_analysis([9883],  "9883 2017-02-6 3-140 ABS-LH2",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 26)) 
    ...
    #analyses.append(get_analysis([10314],  "10314 2017-02-6 3-140 ABS-SOLID-EMPTY",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 26)) 
    #analyses.append(get_analysis([10317],  "10317 2017-02-6 4-140 ABS-SOLID-EMPTY",  [1.5, 6.0], src_dir, data_dir, 4, [[135, 145]], [90, 170], 32)) 
    #analyses.append(get_analysis([10318],  "10318 2017-02-6 6-140 ABS-SOLID-EMPTY",  [1.5, 5.5], src_dir, data_dir, 6, [[135, 145]], [90, 170], 35)) 
    ...
    analyses.append(get_analysis([9911],  "9911 2017-02-6 3-170 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 3, [[165, 175]], [120, 200], 24))
