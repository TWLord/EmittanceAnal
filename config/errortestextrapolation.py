...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp):
    ...
    analysis_variables = {
            ...
            "do_efficiency":False,
            "do_extrapolation":True, #True, ##False,
            "do_globals":False,
            "do_amplitude":False,
            "do_density":False,
...
class Config(object):
    ...
    data_dir = "output/errortest/2017-02-6-v3-OfficialMC+TOFcuts-mc+extrapolation/"
    files = "*/Chris/*/"
    analyses = []
    ...
    #analyses.append(get_analysis("09886",  "2017-02-6 10-140 lH2 full",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70))
