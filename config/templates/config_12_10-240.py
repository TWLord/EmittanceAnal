...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp, momentum):
    ...
    analysis_variables = {
            ...
            "tof01_tramline_lower":-40.+tramlines_dp, # p_tof01 - p_tku
            "tof01_tramline_upper":+40.+tramlines_dp, # p_tof01 - p_tku
...
class Config(object):
    ...
    analyses.append(get_analysis([template],  "template CC 10-240 ABS",  [1.0, 2.25], src_dir, data_dir, 10, [[235, 245]], [190, 270], 64, 240))
