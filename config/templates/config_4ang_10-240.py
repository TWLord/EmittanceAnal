...
def mc_file_names(datasets):
    ...
    for run in datasets: 
        ...
        a_file = "/data/mice/phumhf/analMC/"+run+"_VERSION/*/maus_output.root" 
...
class Config(object):
    ...
    data_dir = "output/c4ang/VERSION/"
    geometry_path = "GEOPATH"
    analyses = []


    analyses.append(get_analysis([template],  "Simulated CC 10-240 ABS",  [1.0, 2.25], src_dir, data_dir, 10, [[235, 245]], [190, 270], 64, 240))
