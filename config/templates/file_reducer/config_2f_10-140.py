...
class Config(object):
    ...
    data_dir = "reduced_files/ReconData/"
    src_dir = "Production-v2"
    analyses = []

    analyses.append(get_analysis([template],  "template",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70)) 
    ...
    preanalysis_number_of_spills = 10000 # number of spills to analyse during "pre-analysis"
    analysis_number_of_spills = 10000 # number of spills to analyse during each "analysis" step
