...
def get_systematics_dir(emittance, suffix, absorber, analysis):
    ...
    a_dir = "output/c7/SYSVERS/plots_CC_"+str(emittance)+\
            "-170_"+absorber+"_"+suffix+"/"+analysis+"/"+analysis+".json"
    return a_dir
...
class Config(object):
    ...
    analyses.append(get_analysis([template],  "template CC 3-170 ABS",  [1.5, 4.5], src_dir, data_dir, 3, [[165, 175]], [120, 200], 24))
