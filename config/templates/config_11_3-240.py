...
def get_systematics_dir(emittance, momentum, suffix, absorber, analysis):
    vers = {
        "amplitude":"SYSVERS",
        "density":"SYSVERS", 
        "density_rogers":"SYSVERS",
        "fractional_emittance":"SYSVERS"
    }[analysis]
...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp, momentum):
    ...
    analysis_variables = {
            ...
            "density_rogers_corrections":get_systematics_dir(emittance, momentum, "tku_base", "SYSTEMATIC", "density_rogers"),
...
class Config(object):
    ...
    data_dir = "output/c11/VERSION/SYSVERS/"
    analyses = []
    reduced_dict_path = None


    analyses.append(get_analysis(["template"],  "Simulated CC 3-240 ABS",  [1.5, 2.75], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24, 240))
