...
class Config(object):
    ...
    analyses.append(get_analysis([template],  "CC 3-170 ABS SYSTEMATIC",  [1.5, 4.5], src_dir, data_dir, 3, [[165, 175]], [120, 200], 24)) 
    if analyses[0]["name"].find("tku_base") >= 0 :
        print "also running --- "
        print " tku_base_tkd_fiducial_radius"
        analyses.append(get_analysis([template],  "CC 3-170 ABS tku_base_tkd_fiducial_radius",  [1.5, 4.5], src_dir, data_dir, 3, [[165, 175]], [120, 200], 24))
        analyses[1]["tkd_fiducial_radius"] = 148. # r2 ~ pt/bz/c_light ~ pt [mm]

        print " tkd_chi2_threshold"
        analyses.append(get_analysis([template],  "CC 3-170 ABS tku_base_tkd_chi2_threshold",  [1.5, 4.5], src_dir, data_dir, 3, [[165, 175]], [120, 200], 24))
