...
def get_systematics_dir(emittance, momentum, suffix, absorber, analysis):
    ...
    a_dir = "output/c4/VERSION/plots_Simulated_CC_"+str(emittance)+"-140_ABS"+\
...
def get_systematics(emittance, momentum, analysis="amplitude"):
    ...
    systematics = {
      "reco":{
        "detector_reference":get_systematics_dir(emittance, momentum, "", "lH2_full", analysis),
        "performance_reference":get_systematics_dir(emittance, momentum, "", "lH2_full", analysis),
        us_name:{
          "detector_systematics":{
            get_systematics_dir(emittance, momentum, "", "lH2_full", analysis):1.,
...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp, momentum):
    ...
    analysis_variables = {
            ...
            "amplitude_corrections":get_systematics_dir(emittance, momentum, "", "lH2_full", "amplitude"), #get_systematics_dir(emittance, momentum, "tku_base", "lH2_empty", "amplitude"),
            "skip_corrections":None, 
            "amplitude_systematics":get_systematics(emittance, momentum, "amplitude"), #get_systematics(emittance, momentum, "amplitude"),
            ...
            "density_corrections":get_systematics_dir(emittance, momentum, "", "lH2_full", "density"), #"density_corrections":get_systematics_dir(emittance, momentum, "tku_base", "lH2_empty", "density"),
...
class Config(object):
    ...
    time_from = "tof1"
    tof0_offset = 25.4 # 25.4+0.18
    tof1_offset = 0.
    tof2_offset = -27.9 # -27.7
    ...
    density_npoints = 150 #100
    density_graph_scaling = 1e9
    density_max = 150.*1e-9 #100.*1e-9
