...
def get_systematics_dir(emittance, momentum, suffix, absorber, analysis):
    ...
    a_dir = "output/c7/SYSVERS/plots_CC_"+str(emittance)+\
            "-"+str(momentum)+"_"+absorber+"_"+suffix+"/"+analysis+"/"+analysis+".json"
    return a_dir
...
def get_systematics(emittance, momentum, analysis="amplitude"):
    ...
    systematics = {
      "reco":{
        "detector_reference":get_systematics_dir(emittance, momentum, "tku_base", "SYSTEMATIC", analysis),
        "performance_reference":get_systematics_dir(emittance, momentum, "tku_base", "SYSTEMATIC", analysis),
        us_name:{
          "detector_systematics":{
            get_systematics_dir(emittance, momentum, "tku_pos_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tku_rot_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tku_scale_E1_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tku_scale_C_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tku_scale_E2_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tku_density_plus", "SYSTEMATIC", analysis):1.,
          },
          "performance_systematics":{}
        },
        ds_name:{
          "detector_systematics":{
            get_systematics_dir(emittance, momentum, "tkd_pos_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tkd_rot_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tkd_scale_E1_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tkd_scale_C_plus", "SYSTEMATIC", analysis):0.1,
            get_systematics_dir(emittance, momentum, "tkd_scale_E2_plus", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tkd_density_plus", "SYSTEMATIC", analysis):1.,
          },
          "performance_systematics":{
            get_systematics_dir(emittance, momentum, "tku_base_tkd_fiducial_radius", "SYSTEMATIC", analysis):1.,
            get_systematics_dir(emittance, momentum, "tku_base_tkd_chi2_threshold", "SYSTEMATIC", analysis):1.,
          }
        }
      },
    }
...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp, momentum):
    ...
    analysis_variables = {
            ...
            "amplitude_corrections":get_systematics_dir(emittance, momentum, "tku_base", "SYSTEMATIC", "amplitude"), #get_systematics_dir(emittance, momentum, "tku_base", "lH2_empty", "amplitude"),
            "skip_corrections":None, 
            "amplitude_systematics":get_systematics(emittance, momentum, "amplitude"),
            ...
            "fractional_emittance_corrections":get_systematics_dir(emittance, momentum,
                                                                   "tku_base", 
                                                                   "SYSTEMATIC",
                                                                   "fractional_emittance"),
            "fractional_emittance_systematics":get_systematics(emittance, momentum, "fractional_emittance"),
            ...
            "density_corrections":get_systematics_dir(emittance, momentum, "tku_base", "SYSTEMATIC", "density"), #"density_corrections":get_systematics_dir(emittance, momentum, "tku_base", "lH2_empty", "density"),
            "density_systematics":get_systematics(emittance, momentum, "density"),
            ...
            "density_rogers_corrections":get_systematics_dir(emittance, momentum, "tku_base", "SYSTEMATIC", "density_rogers"), #"density_rogers_corrections":get_systematics_dir(emittance, momentum, "tku_base", "lH2_empty", "density_rogers"),
            "density_rogers_systematics":get_systematics(emittance, momentum, "density_rogers"),
...
class Config(object):
    ...
    analyses.append(get_analysis([template],  "template CC 10-140 ABS",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70, 140))
