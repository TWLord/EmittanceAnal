...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp):
    ...
    analysis_variables = {
            ...
            "density_rogers_corrections":get_systematics_dir(emittance, "tku_base", "ABS", "density_rogers"),
...
class Config(object):
    ...
    analyses.append(get_analysis(["template"],  "Simulated CC 10-140 ABS",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70)) 
