...
def mc_file_names(datasets):
    ...
    for run in datasets: 
        run = str(run)
        a_file = "/data/mice/phumhf/analMC/"+run+"_systematics_v105/tku_density_plus/0015/maus_reconstruction.root" 
...
class Config(object):
    ...
    data_dir = "output/systematics/2017-02-6-c7_v105/15/"
    analyses = []


    analyses.append(get_analysis([10509],  "2017-02-6 6-140 ABS-SOLID-LiH tku_density_plus",  [1.5, 5.5], src_dir, data_dir, 6, [[135, 145]], [90, 170], 35)) 
