...
def mc_file_names(datasets):
    ...
    for run in datasets: 
        run = str(run)
        a_file = "/data/mice/phumhf/analMC/"+run+"_systematics_v106/tku_rot_plus/*/maus_reconstruction.root" 
...
class Config(object):
    ...
    data_dir = "output/systematics/0/"
    analyses = []


    analyses.append(get_analysis([10508],  "2017-02-6 6-140 ABS-SOLID-LiH tku_rot_plus",  [1.5, 5.5], src_dir, data_dir, 6, [[135, 145]], [90, 170], 35)) 
