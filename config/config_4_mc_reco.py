...
def mc_file_names(datasets):
    ...
    #file_list = ["/data/mice/phumhf/MC/MAUSv3.3.0/"+datasets+"/mausoutput/0/"+datasets+"_1000Spills_2.0NPEDcut_2.0NPEcut_1.root"]
    ####file_list = ["/data/mice/phumhf/MC/MAUSv3.3.0/"+datasets+"/mausoutput/0/"+datasets+"_1000Spills_2.0NPEDcut_2.0NPEcut_*.root"]
    ######file_list = ["/data/mice/phumhf/MC/MAUSv3.3.0/"+datasets+"/mausoutput/0/"+datasets+"_full_100Spills_2.0NPEDcut_2.0NPEcut_2*.root"]
    file_list = ["/data/mice/phumhf/MC/MAUSv3.3.0/"+datasets+"/mausoutput/0/"+datasets+"_full_100Spills_2.0NPEDcut_4.0NPEcut_2*.root"]
    #file_list = ["/data/mice/phumhf/MC/MAUSv3.3.0/"+datasets+"/mausoutput/0/"+datasets+"_1000Spills_2.0NPEDcut_4.0NPEcut_2*.root"]
...
class Config(object):
    ...
    #data_dir = "output/2017-02-6-v3-mc+density-longmc/"
    #data_dir = "output/2017-02-6-v6-mc+density+densityrogers/"
    data_dir = "output/2017-02-6-v6-100spillsmc+density+densityrogers/"
    files = "*/Chris/*/"
    analyses = []
    ...
    analyses.append(get_analysis("09883",  "2017-02-6 3-140 lH2 full",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 32))
    analyses.append(get_analysis("09885",  "2017-02-6 6-140 lH2 full",  [1.5, 6.0], src_dir, data_dir, 6, [[135, 145]], [90, 170], 32))
    analyses.append(get_analysis("09886",  "2017-02-6 10-140 lH2 full",  [1.5, 6.0], src_dir, data_dir, 10, [[135, 145]], [90, 170], 32))
