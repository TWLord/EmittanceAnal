...
class Config(object):
    ...
    data_dir = "output/2017-02-6-v5-reco-sys+corr-longmc-longdata/"
    ...
    analyses.append(get_analysis([9885],  "2017-02-6 6-140 lH2 full",  [1.5, 6.0], src_dir, data_dir, 6, [[135, 145]], [90, 170], 32))
    ...
    preanalysis_number_of_spills = 50 # 500 # number of spills to analyse during "pre-analysis"
    analysis_number_of_spills = 10 # 100 # number of spills to analyse during each "analysis" step
