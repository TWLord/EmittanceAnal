...
class Config(object):
    ...
    analyses.append(get_analysis([10315, 10317, 10322, 10328, 10334],  "10315, 10317, 10322, 10328, 10334 2017-02-6 4-140 ABS-SOLID-EMPTY",  [1.5, 6.0], src_dir, data_dir, 4, [[135, 145]], [90, 170], 32)) 
