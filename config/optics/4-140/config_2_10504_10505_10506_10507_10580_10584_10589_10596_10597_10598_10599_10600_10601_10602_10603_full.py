...
class Config(object):
    ...
    data_dir = "output/reconOnly/"
    src_dir = "Production-v2"
    analyses = []

    analyses.append(get_analysis([10504, 10505, 10506, 10507, 10580, 10584, 10589, 10596, 10597, 10598, 10599, 10600, 10601, 10602, 10603],  "10504, 10505, 10506, 10507, 10580, 10584, 10589, 10596, 10597, 10598, 10599, 10600, 10601, 10602, 10603 2017-02-6 4-140 ABS-SOLID-LiH",  [1.5, 6.0], src_dir, data_dir, 4, [[135, 145]], [90, 170], 32)) 
