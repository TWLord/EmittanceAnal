...
class Config(object):
    ...
    analyses.append(get_analysis([10318, 10324, 10329, 10335],  "10318, 10324, 10329, 10335 2017-02-6 6-140 ABS-SOLID-EMPTY",  [1.5, 5.5], src_dir, data_dir, 6, [[135, 145]], [90, 170], 35)) 
