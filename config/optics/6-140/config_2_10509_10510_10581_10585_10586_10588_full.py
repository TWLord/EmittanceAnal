...
class Config(object):
    ...
    analyses.append(get_analysis([10509, 10510, 10581, 10585, 10586, 10588],  "10509, 10510, 10581, 10585, 10586, 10588 2017-02-6 6-140 ABS-SOLID-LiH",  [1.5, 5.5], src_dir, data_dir, 6, [[135, 145]], [90, 170], 35)) 
