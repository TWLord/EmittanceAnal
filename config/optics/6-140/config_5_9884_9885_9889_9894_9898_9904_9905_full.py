...
class Config(object):
    ...
    analyses.append(get_analysis([9884, 9885, 9889, 9894, 9898, 9904, 9905],  "9884, 9885, 9889, 9894, 9898, 9904, 9905 2017-02-6 6-140 ABS-LH2",  [1.5, 5.5], src_dir, data_dir, 6, [[135, 145]], [90, 170], 35))
