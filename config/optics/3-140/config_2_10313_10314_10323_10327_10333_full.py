...
class Config(object):
    ...
    analyses.append(get_analysis([10313, 10314, 10323, 10327, 10333],  "10313, 10314, 10323, 10327, 10333 2017-02-6 3-140 ABS-SOLID-EMPTY",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 26)) 
