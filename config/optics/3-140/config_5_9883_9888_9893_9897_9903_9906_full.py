...
class Config(object):
    ...
    analyses.append(get_analysis([9883, 9888, 9893, 9897, 9903, 9906],  "9883, 9888, 9893, 9897, 9903, 9906 2017-02-6 3-140 ABS-LH2",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 32))
    ...
    preanalysis_number_of_spills = 500 # 500 # number of spills to analyse during "pre-analysis"
