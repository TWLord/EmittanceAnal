...
class Config(object):
    ...
    analyses.append(get_analysis([10243, 10248, 10253, 10254, 10255, 10256],  "10243, 10248, 10253, 10254, 10255, 10256 2017-02-6 3-140 ABS-LH2-EMPTY",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 26)) 
