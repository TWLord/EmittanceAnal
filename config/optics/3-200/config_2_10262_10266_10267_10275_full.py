...
class Config(object):
    ...
    analyses.append(get_analysis([10262, 10266, 10267, 10275],  "10262, 10266, 10267, 10275 2017-02-6 3-200 ABS-LH2-EMPTY",  [1.5, 4.5], src_dir, data_dir, 3, [[195, 205]], [150, 230], 24)) 
