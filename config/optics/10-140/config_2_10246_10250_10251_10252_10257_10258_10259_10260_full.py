...
class Config(object):
    ...
    analyses.append(get_analysis([10246, 10250, 10251, 10252, 10257, 10258, 10259, 10260],  "10246, 10250, 10251, 10252, 10257, 10258, 10259, 10260 2017-02-6 10-140 ABS-LH2-EMPTY",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70)) 
