...
class Config(object):
    ...
    analyses.append(get_analysis([9886, 9887, 9890, 9891, 9892, 9895, 9896, 9899, 9900, 9901, 9902],  "9886, 9887, 9890, 9891, 9892, 9895, 9896, 9899, 9900, 9901, 9902 2017-02-6 10-140 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70))
