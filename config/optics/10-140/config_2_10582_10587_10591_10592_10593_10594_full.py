...
class Config(object):
    ...
    analyses.append(get_analysis([10582, 10587, 10591, 10592, 10593, 10594],  "10582, 10587, 10591, 10592, 10593, 10594 2017-02-6 10-140 ABS-SOLID-LiH",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70)) 
