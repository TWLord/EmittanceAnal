...
class Config(object):
    ...
    analyses.append(get_analysis([10319, 10321, 10325, 10326, 10330, 10331, 10332],  "10319, 10321, 10325, 10326, 10330, 10331, 10332 2017-02-6 10-140 ABS-SOLID-EMPTY",  [1.5, 4.5], src_dir, data_dir, 10, [[135, 145]], [90, 170], 70)) 
