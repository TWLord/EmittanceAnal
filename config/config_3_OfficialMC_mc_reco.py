...
def mc_file_names(datasets):
    file_list = ["/data/mice/phumhf/MC/MAUSv3.3.2/"+datasets+"/*_sim.root"]
...
class Config(object):
    ...
    data_dir = "output/officialMC/2017-02-6-v3-OfficialMC-mc+density+densityrogers/"
    files = "*/Chris/*/"
    analyses = []
    ...
    analysis_number_of_spills = 20 # 100 # number of spills to analyse during each "analysis" step
