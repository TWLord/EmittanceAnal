...
class Config(object):
    ...
    data_dir = "output/testing/2017-02-6-v6-mc+density+densityrogers/"
    files = "*/Chris/*/"
    analyses = []
    ...
    analyses.append(get_analysis("09885",  "2017-02-6 6-140 lH2 full",  [1.5, 6.0
            ], src_dir, data_dir, 6, [[135, 145]], [90, 170], 32))
