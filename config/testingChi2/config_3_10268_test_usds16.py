...
def get_analysis(run_list, name, tof01_min_max, maus_version, data_dir, emittance, p_bins, tkd_cut, tramlines_dp):
    ...
    analysis_variables = {
            ...
            "tku_chi2_threshold":16.0, # maximum allowed chi2/dof for chi2 cut
            "tkd_chi2_threshold":16.0, # maximum allowed chi2/dof for chi2 cut
...
class Config(object):
    ...
    data_dir = "output/testingchi2/usds16/"
    analyses = []
