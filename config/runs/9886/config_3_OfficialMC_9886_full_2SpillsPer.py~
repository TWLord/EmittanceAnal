...
class Config(object):
    ...
    data_dir = "output/officialMC/2017-02-6-v3-OfficialMC_full/"
    files = "*/Chris/*/"
    analyses = []
    ...
    preanalysis_number_of_spills = 10 # 20 # number of spills to analyse during "pre-analysis"
    analysis_number_of_spills = 2 # 20 # number of spills to analyse during each "analysis" step
