...
#    a_dir = "output/officialMC/corrections/plots_Simulated_2017-02-6_"+str(emittance)+"-140_lH2_full"+\
    a_dir = "output/ownMC/2017-02-6-c4_vVERSION/plots_template_2017-02-6_"+str(emittance)+"-240_ABS"+\
...
class Config(object):
    ...
    data_dir = "output/c6/2017-02-6-c6_vVERSION/"
    src_dir = "Production-v3"
    analyses = []

    analyses.append(get_analysis([template],  "template 2017-02-6 3-240 ABS",  [1.5, 2.75], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24))
