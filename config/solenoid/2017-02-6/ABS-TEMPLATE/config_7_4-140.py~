...
class Config(object):
    ...
    if analyses[0]["name"].find("tku_base") :
        ...
        analyses.append(get_analysis([9883],  "2017-02-6 3-140 ABS tku_base_tkd_fiducial_radius",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 26))
        analyses[1]["tkd_fiducial_radius"] = 148. # r2 ~ pt/bz/c_light ~ pt [mm]

        print " tkd_chi2_threshold"
        analyses.append(get_analysis([9883],  "2017-02-6 3-140 ABS tku_base_tkd_chi2_threshold",  [1.5, 6.0], src_dir, data_dir, 3, [[135, 145]], [90, 170], 26))
