...
def get_systematics_dir(emittance, suffix, absorber, analysis):
    ...
    #a_dir = "output/officialMC/corrections/plots_Simulated_2017-02-6_"+str(emittance)+"-140_ABS"+\
    a_dir = "output/ownMC/2017-02-6-c4_vVERSION/plots_template_2017-02-6_"+str(emittance)+"-140_ABS"+\
...
class Config(object):
    ...
    data_dir = "output/officialMC/2017-02-6-v5-reco-sys+corr-longmc-longdata/"
