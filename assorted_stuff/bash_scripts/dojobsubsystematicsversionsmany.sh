...
#set -- "ABS-LH2" "9885,6-140" "ABS-LH2-EMPTY" "10243,3-140" "ABS-LH2-EMPTY" "10245,6-140" "ABS-SOLID-EMPTY" "10314,3-140" "ABS-SOLID-EMPTY" "10318,6-140" "ABS-SOLID-LiH" "10508,3-140" "ABS-SOLID-LiH" "10509,6-140"
#set -- "ABS-LH2" "9883,3-140" "ABS-SOLID-LiH" "10509,6-140"
#set -- "ABS-LH2" "9883,3-140" 
#set -- "ABS-LH2" "9909,3-240" "ABS-LH2-EMPTY" "10265,3-240" "ABS-LH2" "9910,3-200" "ABS-LH2-EMPTY" "10267,3-200" "ABS-LH2" "9911,3-170" "ABS-LH2-EMPTY" "10268,3-170" 
#set -- "ABS-LH2" "9911,3-170" "ABS-LH2-EMPTY" "10268,3-170" 
#set -- "ABS-SOLID-LiH" "10509,6-140"

# Sets for 
set -- "ABS-LH2" "9883,3-140" "ABS-LH2" "9885,6-140" 
#set -- "ABS-LH2" "9883,3-140" "ABS-SOLID-EMPTY" "10317,4-140" "ABS-LH2" "9885,6-140" "ABS-LH2" "9886,10-140" 
...
bsub -G micegrp -M 20000 -oo $here/logs/${runnumber}_systematics_${systematic}v${VERSION}.log -q ${queue} $here/logs/tmp/${runnumber}_systematics_${systematic}v${VERSION}.sh
