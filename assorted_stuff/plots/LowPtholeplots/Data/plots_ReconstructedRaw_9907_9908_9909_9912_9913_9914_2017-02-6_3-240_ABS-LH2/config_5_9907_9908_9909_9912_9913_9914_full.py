...
def reco_file_names(run_number_list, maus):
    ...
    for run in run_number_list:
        ...
        a_file = "/data/mice/phumhf/ReconstructedRawData/MAUSv3.3.2/run_"+run+"/"+run+"_*.root" # "+maus+"/"+run+"/"+run+"_recon"
...
class Config(object):
    ...
    analyses.append(get_analysis([9907, 9908, 9909, 9912, 9913, 9914],  "ReconstructedRaw 9907, 9908, 9909, 9912, 9913, 9914 2017-02-6 3-240 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24))
    #analyses.append(get_analysis([9907, 9908, 9909, 9912, 9913],  "9907, 9908, 9909, 9912, 9913 2017-02-6 3-240 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24))
