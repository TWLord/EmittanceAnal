...
class Config(object):
    ...
    data_dir = "output/reconOnly/Geom264/"
    src_dir = "Production-v2"
    analyses = []

    analyses.append(get_analysis([9907, 9908, 9909, 9912, 9913, 9914],  "9907, 9908, 9909, 9912, 9913, 9914 2017-02-6 3-240 ABS-LH2",  [1.5, 2.75], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24)) 
