...
class Config(object):
    ...
    #analyses.append(get_analysis([9907, 9908, 9909, 9912, 9913, 9914],  "9907, 9908, 9909, 9912, 9913, 9914 2017-02-6 3-240 ABS-LH2",  [1.5, 4.5], src_dir, data_dir, 3, [[235, 245]], [190, 270], 24))
